  ...
  c.extend(g, {
    ...
    bindEvents: function() {
      ...
      function(a, d, e, f) {
        ...
        i = c(h), j = !1; i.length && !(j || i.is(".fancybox-skin") || i.is(".fancybox-wrap"));) {
          j = n(i[0]),
          i = c(i).parent()
        }
...
!function(a) {
  ...
  b.prototype.swipeEnd = function(b) {
    ...
    if (c.touchObject.swipeLength >= c.touchObject.minSwipe) {
      switch (a(b.target).on("click.slick",
      function(b) {
  ...
  a.ias.history = function() {
    ...
    this.getState = function() {
      ...
      if (c) {
        ...
        if (a = "#/page/" === window.location.hash.substring(0, 7)) {
