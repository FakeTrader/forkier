jQuery(document).ready(function() {
  function a(a, b, c) {
    var d, e, f;
    document.selection ? (a.focus(),
    sel = document.selection.createRange(),
    sel.text = c ? b + sel.text + c : b,
    a.focus()) : a.selectionStart || "0" == a.selectionStart ? (d = a.selectionStart,
    e = a.selectionEnd,
    f = e,
...
!function(a) {
  ...
  f.prototype = {
    ...
    toggle: function() {
      var d, e, f = a(this);
      return f.is(".disabled, :disabled") ? void 0 : (d = c(f),
      e = d.hasClass("open"),
      b(),
    ...
    keydown: function(b) {
      var d, f, g, h, i;
      if (/(38|40|27)/.test(b.keyCode) && (d = a(this),
      b.preventDefault(),
      b.stopPropagation(),
      !d.is(".disabled, :disabled"))) {
        ...
        h = g.hasClass("open"),
        !h || h && 27 == b.keyCode)
          return 27 == b.which && g.find(e).focus(),
          d.click();
        f = a("[role=menu] li:not(.divider):visible a", g),
        f.length && (i = f.index(f.filter(":focus")),
        38 == b.keyCode && i > 0 && i--,
...
!function(a) {
  ...
  c.prototype = {
    ...
    show: function() {
      ...
      g || (g = e.attr("href"),
      g = g && g.replace(/.*(?=#[^\s]*$)/, "")),
      e.parent("li").hasClass("active") || (b = f.find(".active:last a")[0],
      d = a.Event("show", {
        relatedTarget: b
      }),
      e.trigger(d),
      d.isDefaultPrevented() || (c = a(g),
...
!function(a) {
  ...
  b.prototype.buildArrows = function() {
    var b = this;
    b.options.arrows === !0 && b.slideCount > b.options.slidesToShow && (b.$prevArrow = a('<button type="button" class="slick-prev">Previous</button>').appendTo(b.$slider),
  ...
  b.prototype.checkResponsive = function() {
    ...
    if (d.originalSettings.responsive && d.originalSettings.responsive.length > -1 && null !== d.originalSettings.responsive) {
      ...
      null !== c ? null !== d.activeBreakpoint ? c !== d.activeBreakpoint && (d.activeBreakpoint = c,
      d.options = a.extend({}, d.defaults, d.breakpointSettings[c]),
      d.refresh()) : (d.activeBreakpoint = c,
      d.options = a.extend({}, d.defaults, d.breakpointSettings[c]),
      d.refresh()) : null !== d.activeBreakpoint && (d.activeBreakpoint = null,
  ...
  b.prototype.destroy = function() {
    ...
    b.$prevArrow && (b.$prevArrow.remove(),
    b.$nextArrow.remove()),
  ...
  b.prototype.getLeft = function(a) {
    ...
    d.options.infinite === !0 ? (d.slideCount > d.options.slidesToShow && (d.slideOffset = -1 * d.slideWidth * d.options.slidesToShow,
    e = -1 * c * d.options.slidesToShow),
    0 !== d.slideCount % d.options.slidesToScroll && a + d.options.slidesToScroll > d.slideCount && d.slideCount > d.options.slidesToShow && (d.slideOffset = -1 * d.slideCount % d.options.slidesToShow * d.slideWidth,
    e = -1 * d.slideCount % d.options.slidesToShow * c)) : 0 !== d.slideCount % d.options.slidesToShow && a + d.options.slidesToScroll > d.slideCount && d.slideCount > d.options.slidesToShow && (d.slideOffset = d.options.slidesToShow * d.slideWidth - d.slideCount % d.options.slidesToShow * d.slideWidth,
  ...
  b.prototype.initializeEvents = function() {
    ...
    b.options.pauseOnHover === !0 && b.options.autoplay === !0 && (b.$list.on("mouseenter.slick", b.autoPlayClear),
  ...
  b.prototype.lazyLoad = function() {
    var b, c, d, e, f = this;
    f.options.centerMode === !0 ? (d = f.options.slidesToShow + f.currentSlide - 1,
    e = d + f.options.slidesToShow + 2) : (d = f.options.infinite ? f.options.slidesToShow + f.currentSlide : f.currentSlide,
    ...
    f.currentSlide >= f.slideCount - f.options.slidesToShow ? (c = f.$slider.find(".slick-cloned").slice(0, f.options.slidesToShow),
    ...
    })) : 0 === f.currentSlide && (c = f.$slider.find(".slick-cloned").slice(-1 * f.options.slidesToShow),
    a("img[data-lazy]", c).not("[src]").each(function() {
      a(this).css({
        opacity: 0
      }).attr("src", a(this).attr("data-lazy")).removeClass("slick-loading").load(function() {
  ...
  b.prototype.progressiveLazyLoad = function() {
    ...
    b > 0 && (c = a(a("img[data-lazy]", d.$slider).not("[src]").get(0)),
  ...
  b.prototype.removeSlide = function(a, b) {
    ...
    a = b === !0 ? 0 : c.slideCount - 1) : a = b === !0 ? --a : a,
    c.slideCount < 1 || 0 > a || a > c.slideCount - 1 ? !1 : (c.unload(),
  ...
  b.prototype.setDimensions = function() {
    ...
    a.options.vertical === !1 ? (a.$slideTrack.width(Math.ceil(a.slideWidth * a.$slideTrack.children(".slick-slide").length)),
    a.options.centerMode === !0 && a.$list.css({
      padding: "0px " + a.options.centerPadding
    })) : (a.$list.height(a.$slides.first().outerHeight() * a.options.slidesToShow),
    a.$slideTrack.height(Math.ceil(a.$slides.first().outerHeight() * a.$slideTrack.children(".slick-slide").length)),
    a.options.centerMode === !0 && a.$list.css({
  ...
  b.prototype.setProps = function() {
    ...
    void 0 !== document.body.style.MozTransform && (a.animType = "MozTransform",
    a.transformType = "-moz-transform",
    a.transitionType = "MozTransition"),
    void 0 !== document.body.style.webkitTransform && (a.animType = "webkitTransform",
    a.transformType = "-webkit-transform",
    a.transitionType = "webkitTransition"),
    void 0 !== document.body.style.msTransform && (a.animType = "transform",
  ...
  b.prototype.setSlideClasses = function(a) {
    ...
    e.options.centerMode === !0 ? (b = Math.floor(e.options.slidesToShow / 2),
    a >= b && a <= e.slideCount - 1 - b ? e.$slides.slice(a - b, a + b + 1).addClass("slick-active") : (d = e.options.slidesToShow + a,
    c.slice(d - b + 1, d + b + 2).addClass("slick-active")),
    0 === a ? c.eq(c.length - 1 - e.options.slidesToShow).addClass("slick-center") : a === e.slideCount - 1 && c.eq(e.options.slidesToShow).addClass("slick-center"),
    e.$slides.eq(a).addClass("slick-center")) : a > 0 && a < e.slideCount - e.options.slidesToShow ? e.$slides.slice(a, a + e.options.slidesToShow).addClass("slick-active") : (d = e.options.infinite === !0 ? e.options.slidesToShow + a : a,
  ...
  b.prototype.setupInfinite = function() {
    var b, c, d, e = this;
    if ((e.options.fade === !0 || e.options.vertical === !0) && (e.options.centerMode = !1),
  ...
  b.prototype.slideHandler = function(a) {
    ...
    return g.animating === !0 ? !1 : (b = a,
    f = g.getLeft(b),
    d = g.getLeft(g.currentSlide),
    e = 0 !== g.slideCount % g.options.slidesToScroll ? g.options.slidesToScroll : 0,
    g.currentLeft = null === g.swipeLeft ? d : g.swipeLeft,
    g.options.infinite === !1 && (0 > a || a > g.slideCount - g.options.slidesToShow + e) ? (b = g.currentSlide,
    g.animateSlide(d, function() {
      g.postSlide(b)
    }),
    !1) : (g.options.autoplay === !0 && clearInterval(g.autoPlayTimer),
    c = 0 > b ? 0 !== g.slideCount % g.options.slidesToScroll ? g.slideCount - g.slideCount % g.options.slidesToScroll : g.slideCount - g.options.slidesToScroll : b > g.slideCount - 1 ? 0 : b,
    g.animating = !0,
    ...
    g.updateDots(),
    g.updateArrows(),
    g.options.fade === !0 ? (g.fadeSlide(c, function() {
      g.postSlide(c)
    }),
  ...
  b.prototype.swipeEnd = function(b) {
    var c = this;
    if (c.$list.removeClass("dragging"),
  ...
  b.prototype.swipeMove = function(a) {
    ...
    !f.$list.hasClass("dragging") || e && 1 !== e.length ? !1 : (f.touchObject.curX = void 0 !== e ? e[0].pageX : a.clientX,
  ...
  b.prototype.updateArrows = function() {
    ...
    a.$nextArrow.removeClass("slick-disabled")) : a.currentSlide >= a.slideCount - a.options.slidesToShow && (a.$nextArrow.addClass("slick-disabled"),
...
function(a) {
  ...
  a.ias = function(b) {
    function c() {
      ...
      s.triggerPageThreshold > 0 ? d() : a(s.next).attr("href") && (c = t.getCurrentScrollOffset(s.scrollContainer),
      q(function() {
        i(c)
      })),
      v && v.havePage() && (f(),
    ...
    function e() {
      ...
      b = h(),
      a >= b && (l() >= s.triggerPageThreshold ? (f(),
      q(function() {
        i(a)
      })) : i(a))
    }
    ...
    function h(b) {
      ...
      0 === c.size() ? 0 : (d = c.offset().top + c.height(),
      b || (d += s.thresholdMargin),
      d)
    }
    function i(b, c) {
      var e;
      return (e = a(s.next).attr("href")) ? (s.beforePageChange && a.isFunction(s.beforePageChange) && s.beforePageChange(b, e) === !1 || (u.pushPages(b, e),
      f(),
      n(),
      j(e, function(b, h) {
      ...
      void 0) : (s.noneleft && a(s.container).find(s.item).last().after(s.noneleft),
      f())
    }
    function j(b, c, d) {
      var e, f, g, h = [], i = Date.now();
      d = d || s.loaderDelay,
      a.get(b, null, function(b) {
    ...
    function m() {
      var b = a(".ias_loader");
      return 0 === b.size() && (b = a('<div class="ias_loader">' + s.loader + "</div>"),
      b.hide()),
      b
    }
    function n() {
      var b, c = m();
      s.customLoaderProc !== !1 ? s.customLoaderProc(c) : (b = a(s.container).find(s.item).last(),
      b.after(c),
      c.fadeIn())
    }
    function o() {
    ...
    function p(b) {
      var c = a(".ias_trigger");
      return 0 === c.size() && (c = a('<div class="ias_trigger"><a href="#">' + s.trigger + "</a></div>"),
      c.hide()),
      a("a", c).unbind("click").bind("click", function() {
        return r(),
        b.call(),
        !1
      }),
    ...
    function q(b) {
      var c, d = p(b);
      s.customTriggerProc !== !1 ? s.customTriggerProc(d) : (c = a(s.container).find(s.item).last(),
      c.after(d),
      d.fadeIn())
    }
    function r() {
  ...
  a.ias.history = function() {
    ...
    this.getPage = function() {
      var a;
      return this.havePage() ? (a = this.getState(),
      a.page) : 1
    }
    ,
    this.getState = function() {
      ...
      if (c) {
        ...
        return d = parseInt(window.location.hash.replace("#/page/", ""), 10),
        {
          page: d
        };
      return !1
...
+function(a) {
  a(document).ready(function() {
    ...
    function c() {
      t > 0 ? ($submit.val(t),
      t--,
      setTimeout(c, 1e3)) : ($submit.val(u).attr("disabled", !1).fadeTo("slow", 1),
      t = 15)
    }
    function d(b, c) {
      c || (c = 1e3),
    ...
    function f(a) {
      ...
      document.selection ? (myField.focus(),
      sel = document.selection.createRange(),
      sel.text = a,
      myField.focus()) : g(a)
    }
    function g(a) {
      myField = document.getElementById("comment"),
      myField.selectionStart || "0" == myField.selectionStart ? (startPos = myField.selectionStart,
      endPos = myField.selectionEnd,
      cursorPos = startPos,
      myField.value = myField.value.substring(0, startPos) + a + myField.value.substring(endPos, myField.value.length),
      cursorPos += a.length,
      myField.focus(),
      myField.selectionStart = cursorPos,
      myField.selectionEnd = cursorPos) : (myField.value += a,
      myField.focus())
    }
    ...
    !e() && a(".sidebar").length && (h = a(".sidebar .widget"),
    i = h.length,
    i && 0 < _deel.roll[0] <= i && 0 < _deel.roll[1] <= i && a(window).scroll(function() {
      var b, c = document.documentElement.scrollTop + document.body.scrollTop;
      c > h.eq(i - 1).offset().top + h.eq(i - 1).height() ? 0 == a(".widgetRoller").length ? (h.parent().append('<div class="widgetRoller"></div>'),
      h.eq(_deel.roll[0] - 1).clone().appendTo(".widgetRoller"),
      _deel.roll[0] !== _deel.roll[1] && h.eq(_deel.roll[1] - 1).clone().appendTo(".widgetRoller"),
      b = 10,
    ...
    a.fn.postLike = function() {
      ...
      return a(this).hasClass("actived") ? alert("已经点过赞啦！") : (a(this).addClass("actived"),
      b = a(this).data("id"),
    ...
    a(document).on("click", function(b) {
      ...
      e = a(c),
      !e.hasClass("disabled"))
        switch (e.parent().attr("data-type") && (e = a(e.parent()[0])),
        e.parent().parent().attr("data-type") && (e = a(e.parent().parent()[0])),
        g = e.attr("data-type")) {
        case "screen-nav":
          h = a(".navbar .nav"),
          i = a(".navbar .nav"),
    ...
    a("#commentform").submit(function() {
      ...
      a.ajax({
        ...
        success: function(b) {
          ...
          d.I("comment_parent").value);
          !l && $comments.length && (n = parseInt($comments.text().match(/\d+/)),
    ...
    addComment = {
      moveForm: function(c, d, e, f, g) {
        ...
        l && b(),
        g ? (i.I("comment").value = s[g],
        l = i.I("new_comm_" + g).innerHTML.match(/(comment-)(\d+)/)[2],
        $new_sucs = a("#success_" + g),
        $new_sucs.hide(),
        $new_comm = a("#new_comm_" + g),
        $new_comm.hide(),
        $cancel.text(q)) : $cancel.text(cancel_text),
        i.respondId = e,
        f = f || !1,
        i.I("wp-temp-form-div") || (h = document.createElement("div"),
        h.id = "wp-temp-form-div",
        h.style.display = "none",
        k.parentNode.insertBefore(h, k)),
        j ? j.parentNode.insertBefore(k, j.nextSibling) : (temp = i.I("wp-temp-form-div"),
        ...
        m.onclick = function() {
          ...
          c && d && (c.parentNode.insertBefore(d, c),
...
!function(a) {
  a.extend(a.fn, {
    posfixed: function(b) {
      ...
      a.extend(f, b),
      a.browser.msie && 6 == a.browser.version && (a("html").css("overflow", "hidden"),
      a("body").css({
        height: "100%",
        overflow: "auto"
      })),
      ...
      "while" == f.type && (a.browser.msie && 6 == a.browser.version ? a("body").scroll(function() {
        ...
        b <= f.distance && (a(c).css("position", "absolute"),
        a(c).css("top", f.distance + "px"),
        a(c).css("left", e + "px")),
        a(c).offset().top <= d && a(c).css("position", "static")
      }) : a(window).scroll(function() {
        var b, e;
        "top" == f.direction ? (b = a(c).offset().top - a(window).scrollTop(),
        b <= f.distance && (a(c).css("position", "fixed"),
        a(c).css(f.direction, f.distance + "px")),
        a(c).offset().top <= d && a(c).css("position", "static")) : (e = a(window).height() - a(c).offset().top + a(window).scrollTop() - a(c).outerHeight(),
        e <= f.distance && (a(c).css("position", "fixed"),
        a(c).css(f.direction, f.distance + "px")),
        a(c).offset().top >= d && a(c).css("position", "static"))
      })),
      "always" == f.type && (a.browser.msie && 6 == a.browser.version ? (f.hide && a(c).hide(),
      a("body").scroll(function() {
        a("body").scrollTop() > 300 ? a(c).fadeIn(200) : a(c).fadeOut(200)
      }),
      a(c).css("position", "absolute"),
      a(c).css(f.direction, f.distance + "px"),
      null != f.tag && (null != f.tag.obj ? "right" == f.tag.direction ? (a(c).css("left", f.tag.obj.offset().left + f.tag.obj.width() + f.tag.distance + "px"),
      a(window).resize(function() {
        a(c).css("left", f.obj.tag.offset().left + f.tag.obj.width() + f.tag.distance + "px")
      })) : (console.log(f.tag.obj.offset().left - f.tag.obj.width() - f.tag.distance),
      a(c).css("left", f.tag.obj.offset().left - a(c).outerWidth() - f.tag.distance + "px"),
      a(window).resize(function() {
        a(c).css("left", f.tag.obj.offset().left - a(c).outerWidth() - f.tag.distance + "px")
      })) : a(c).css(f.tag.direction, f.tag.distance + "px"))) : (f.hide && a(c).hide(),
      a(window).scroll(function() {
